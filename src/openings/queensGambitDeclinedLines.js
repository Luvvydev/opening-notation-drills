...
export const queensGambitDeclinedLines = withOpeningFeedback([
  {
    ...
    "explanations": [
      ...
      "Let's learn the Queen's Gambit Declined! When White plays {{square d4}}, answer with pawn to {{square d5}} and build a solid center.",
      ...
      "Develops knight, attacking the {{square c4}} pawn indirectly.",
      "Forces Black to decide about the {{bishop b4 full}}.",
      ...
      "White develops bishop actively, eyeing the {{square h7}} square.",
      ...
      "Forced: King moves to {{square h8}} to avoid checkmate threats.",
      "White retreats bishop, maintaining the attack with threats like Q{{square h7}}#."
    ]
  },
  {
    "category": "Queen's Gambit Declined",
    ...
    "explanations": [
      ...
      "White develops knight, increasing pressure on {{square d5}}.",
      "Black develops knight, defending the {{square d5}} pawn indirectly.",
      ...
      "White immediately attacks the isolated {{square d5}} pawn.",
