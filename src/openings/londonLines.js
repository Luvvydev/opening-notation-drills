...
export const londonLines = withOpeningFeedback([
  // Categories: Classic London, Early ...c5 Systems, Anti Bishop Ideas, Jobava London, Aggressive Plans
...

  {
    ...
    explanations: [
      "White starts with {{square d4}}. This pawn is the base of almost every London setup.",
      "Black mirrors with ...{{square d5}}, so the center is balanced.",
      "B{{square f4}} comes out before {{square e3}} closes the bishop in. This is the London habit to remember.",
      "Black develops the knight and adds control over {{square e4}}.",
      "{{square e3}} supports {{square d4}} and opens the queen and dark-squared bishop.",
      "Black prepares the normal bishop trade with ...B{{square d6}}.",
      "N{{square f3}} develops and adds another defender to the center.",
      "Black offers the bishop trade. This is one of the first decisions London players need to know.",
      "B{{square g3}} keeps your London bishop. If Black takes later, hx{{square g3}} opens the h-file and your attack still has a clear plan."
    ]
  },

  {
    ...
    explanations: [
      ...
      "Black mirrors, so the first few moves stay very familiar.",
      "B{{square f4}} develops the London bishop before the pawn chain closes.",
      "Black develops and watches {{square e4}}.",
      "{{square e3}} supports {{square d4}} and prepares smooth development.",
      "Black sets up the common ...B{{square d6}} trade.",
      "N{{square f3}} develops and keeps the setup compact.",
      "Black attacks your London bishop and asks for a decision.",
      "B{{square g3}} keeps the bishop on the kingside diagonal.",
      "If Black takes, they remove your bishop but give you a useful open file.",
      "hx{{square g3}} opens the h-file. Your rook can use that file later when the kingside attack starts."
    ]
  },

  {
    ...
    explanations: [
      "Start with {{square d4}} and take space.",
      "Black mirrors with ...{{square d5}}.",
      "B{{square f4}} gets outside the pawn chain early.",
      "Black develops toward the center.",
      "{{square e3}} protects {{square d4}} and opens your other bishop.",
      "Black supports the center and prepares ...B{{square d6}}.",
      "N{{square f3}} develops normally.",
      "Black offers to trade your London bishop.",
      "Bx{{square d6}} is the simple answer. Use it when you want a lower-theory position and do not want to manage the Bg3 retreat."
    ]
  },

  {
    ...
    explanations: [
      "Open with {{square d4}} and set the London structure in motion.",
      "Black mirrors and keeps the center fixed.",
      "B{{square f4}} comes out before {{square e3}}.",
      "Black develops a knight and contests central squares.",
      "{{square e3}} supports the center and frees your dark-squared bishop.",
      "Black prepares normal development and the bishop trade idea.",
      "N{{square f3}} develops and supports {{square e5}} later.",
      "Black points the bishop at your London bishop.",
      "{{square h3}} gives your bishop and knight more room by stopping an easy ...B{{square g4}} pin."
    ]
  },

  {
    ...
    explanations: [
      "Start with {{square d4}}. This is the pawn your whole shell protects.",
      "Black mirrors, so you can build the normal London setup.",
      "B{{square f4}} comes out first. Remember this before playing {{square e3}}.",
      "Black develops and fights for the center.",
      "{{square e3}} locks in support for {{square d4}}.",
      "Black prepares normal development and keeps ...{{square c5}} available.",
      "N{{square f3}} develops and supports the future N{{square e5}} jump.",
      "Black offers the bishop trade with ...B{{square d6}}.",
      "{{square c3}} completes the pawn pyramid. Your {{square d4}} pawn is now much harder to attack.",
      "Black castles and reaches a normal Queen's Pawn structure.",
      "Nb{{square d2}} supports {{square e4}} and {{square e5}}. This is the quiet shell you can repeat in many games."
    ]
  },

  {
    ...
    name: "Full London shell: c3, Nbd2, Bd3",
    ...
    explanations: [
      ...
      "B{{square f4}} gets outside the pawn chain before anything else.",
      ...
      "Black challenges the center with the standard ...{{square c5}} break.",
      "Nb{{square d2}} supports {{square e4}} and N{{square e5}}. You keep building before reacting too much.",
      "Black develops and adds more pressure to {{square d4}}.",
      "{{square c3}} is the final pawn in the usual London pyramid. It overprotects {{square d4}}.",
      "Black aims for the standard bishop trade.",
      "B{{square d3}} is the attacking square. The bishop points straight at {{square h7}}.",
      "Black castles, and White has reached the full London shell: d4, e3, c3, Nf3, Nbd2, and Bd3."
    ]
  },

  {
    ...
    explanations: [
      "Claim space with {{square d4}}.",
      "Black mirrors and contests {{square d4}}.",
      "B{{square f4}} develops before {{square e3}} closes the diagonal.",
      "Black develops and increases central influence.",
      "{{square e3}} supports {{square d4}} and opens your pieces.",
      "Black supports {{square d5}} and prepares ...B{{square d6}}.",
      "N{{square f3}} develops and prepares the jump to {{square e5}}.",
      "Black attacks your London bishop.",
      "N{{square e5}} is the main teaching jump. If Black takes with ...Bx{{square e5}}, dx{{square e5}} hits the {{square f6}} knight and clears the way for Q{{square h5}} ideas."
    ]
  },

  {
    ...
    name: "Nbd2 into Ne5 and e4 ideas",
  ...
  {
    category: "Early ...c5 Systems",
    id: "london-vs-early-c5",
    name: "Meet early ...c5 with c3",
...

  {
    ...
    name: "Early dxc5 structure change",
...

  {
    ...
    name: "dxc5 trap with b4 and Bb5+",
  ...
  {
    category: "Anti Bishop Ideas",
    id: "london-vs-nh5",
    name: "Answer early ...Nh5 with Be5",
...

  {
    category: "Anti Bishop Ideas",
    id: "london-vs-bf5",
    name: "Early ...Bf5 into c4 and Qb3",
...

  {
    ...
    name: "King's Indian setup: grab the center",
...

  {
    ...
    name: "...g6 setup: castle long and attack",
