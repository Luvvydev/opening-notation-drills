...
export const italianGameLines = withOpeningFeedback([
  {
    ...
    "explanations": [
      "Let's learn the Italian game! This is by far the most played opening at the non pro level. Let's just get into it with pawn to e4.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "Prepare d4. This is the core Italian center attack, hitting both the bishop and the e5 pawn.",
      "Black develops the knight with tempo by attacking the e4 pawn.",
      "Strike in the center with tempo on the bishop and the e5 pawn.",
      ...
      "Black grabs e4 because the knight is pinned, but that also turns the e-file into White's attacking highway.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "Black takes in the center, but White gets open lines and rapid development.",
      "White recaptures with the c-pawn to keep the center mobile and open the c-file.",
      "Passive retreat. If Black does not check on b4, White's central pawns keep rolling.",
      ...
      "Ask the knight to decide before it causes trouble on f2.",
      "The knight retreats to the edge of the board, passive but safe.",
      "Key move. White plays d5 first, seizes the initiative, and keeps Black from consolidating.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "White blocks the check while developing a piece to its natural square.",
      "Black exploits the pin to grab e4, but falls further behind in development.",
      "Do not defend passively. Castling unpins the knight and keeps the initiative.",
      ...
      "Critical move. White grabs the initiative before Black can stabilize with ...d5 himself.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "Best defensive resource. Black checks first so White cannot just keep rolling the center.",
      "White blocks the check while developing a piece to its natural square.",
      "Black takes e4 because the knight is pinned, but White gets the e-file for the attack.",
      "Do not defend passively. Castling unpins the knight and keeps the initiative.",
      ...
      "Queen check keeps the king uncomfortable and the knight on b4 under pressure.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "White blocks the check while developing a piece to its natural square.",
      "Black exploits the pin to grab e4, but White gets the initiative and open e-file.",
      "Do not defend passively. Castling unpins the knight and keeps the initiative.",
      "Black captures the knight, removing a defender from White's position.",
      "Critical move. White plays d5 before Black can consolidate with ...d5 himself.",
      ...
      "White's queen joins the attack with tempo against g7 and the knight.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "White's bishop takes up an aggressive post on the f7-hitting diagonal.",
      "Black develops the bishop symmetrically, creating the Italian Game structure.",
      "Prepare d4. The point of c3 is a clear center strike, not a random waiting move.",
      "Slow move. Black tries to rule out Bg5 ideas but gives White extra time.",
      "Use the tempo immediately. White hits the bishop and e5 before Black has real counterplay.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "This is the Max Lange idea: pin the e4 knight and attack with development instead of material.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "White blocks the check while developing a piece to its natural square.",
      "Black grabs e4 thanks to the pin, but White gets dangerous activity for it.",
      "Do not defend passively. Castling unpins the knight and keeps the initiative.",
      "Black captures the knight, removing a defender from White's position.",
      "Critical move. White plays d5 first and keeps Black from consolidating.",
      "The bishop retreats, but the piece no longer helps defend the king.",
      "Re1 is the natural attacking move. White immediately points a rook at the pinned knight.",
      ...
      "Pin the knight and increase the pressure on f6 and f7.",
      "Black captures the bishop, exchanging pieces.",
      "The knight jump keeps the attack alive and increases the pressure on f7.",
      ...
      "Typical attacking sacrifice. White rips open the king once enough pieces point at f7.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "White blocks the check while developing a piece to its natural square.",
      "Black exploits the pin to grab e4, but that gives White the e-file and the initiative.",
      "Do not defend passively. Castling unpins the knight and keeps the initiative.",
      "Black captures the knight, removing a defender from White's position.",
      "Critical move. White claims d5 first because if Black gets ...d5 in, the whole attack slows down.",
      "The knight moves to a central square, attacking multiple pieces.",
      "White recaptures, maintaining material balance.",
      "Black captures the bishop, winning material but exposing the king.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "White blocks the check while developing a piece to its natural square.",
      "Black exploits the pin to grab e4, but White gets dangerous attacking play in return.",
      "Do not defend passively. Castling unpins the knight and keeps the initiative.",
      "Black captures the knight, removing a defender from White's position.",
      "Critical move. White seizes d5 before Black can use that square to consolidate.",
      ...
      "Black captures the bishop, exchanging pieces.",
      "The knight lands on g5 and keeps the attack focused on f7 and h7.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "White develops the knight, attacks e5, and prepares d4.",
      "The Philidor setup supports e5 and keeps Black compact.",
      "White seizes more space and challenges the center directly.",
      "Black develops and adds pressure to d4 and e5.",
      "White pins the knight and increases pressure on e5.",
      ...
      "White castles long and activates the rook on d1."
    ]
  },
  {
    "category": "Italian Game",
    ...
    "explanations": [
      ...
      "White places the bishop on an active diagonal, eyeing d6 and e5.",
      "Black secures the king.",
      "White connects the rooks and prepares long castling.",
      "Useful waiting move that controls b5 and gives Black some luft.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "Black breaks the pin and prepares ...Bxc6.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "White blocks the check while developing a piece to its natural square.",
      "Black uses the pin to grab e4, but White still gets the initiative.",
      "Do not defend passively. Castling unpins the knight and keeps the initiative.",
      "Black captures the knight, removing a defender from White's position.",
      "Critical move. White claims d5 first and stops Black from consolidating with ...d5.",
      "Black retreats the bishop to a defensive square.",
      "White develops the rook, attacking the pinned knight.",
      "The knight retreats to a safer square.",
      "White captures the knight, regaining material.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "Best defensive resource. Black checks first so White cannot just keep rolling the center.",
      "White blocks the check while developing a piece to its natural square.",
      "Black exploits the pin to grab e4, but White gets activity and open lines for the attack.",
      "Do not defend passively. Castling unpins the knight and keeps the initiative.",
      "Black captures the knight, removing a defender from White's position.",
      "Critical move. White plays d5 first and keeps Black from consolidating.",
      "Black retreats the bishop to a defensive square.",
      ...
      "The king is forced to capture, exposing itself to attack.",
      "Bring the queen in immediately. The attack now revolves around direct threats on h7 and f7.",
      "The king retreats to g8, the only safe square.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "White blocks the check while developing a piece to its natural square.",
      "Black grabs e4 because the knight is pinned, but White keeps the initiative.",
      "Do not defend passively. Castling unpins the knight and keeps the initiative.",
      "Black captures the knight, removing a defender from White's position.",
      "Critical move. White plays d5 first because giving Black time for ...d5 would stabilize everything.",
      "The knight moves to a central square, attacking multiple pieces.",
      "White recaptures, maintaining material balance.",
      "Black captures the bishop, winning material but exposing the king.",
      "Brilliant queen move! White attacks both g7 and the knight simultaneously.",
  ...
  },
  {
    ...
    "explanations": [
      ...
      "White's bishop takes up an aggressive post on the f7-hitting diagonal.",
      "Black develops the bishop symmetrically, creating the Italian Game structure.",
      "Prepare d4. c3 gives White a direct center-attacking plan.",
      "Slow move. Black spends a tempo on ...h6 and gives White extra room for action.",
      ...
      "The queen creates a double attack on the bishop and f7, keeping Black under tactical pressure.",
