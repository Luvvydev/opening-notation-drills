...
export const ruyLopezLines = withOpeningFeedback([
...

  {
    ...
    explanations: [
      ...
      "Strike now! We challenge the {{square d6}}-{{square e5}} structure directly.",
      ...
      "Castle! We secure our king and activate the rook. The {{square f1}}-{{square e1}}-{{square d1}} route is coming.",
